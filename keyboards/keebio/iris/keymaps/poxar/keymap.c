...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
      ...
      KC_LSPO, LT(4, KC_Z), KC_X, KC_C, KC_V, KC_B, KC_MINS, KC_EQL, KC_N, KC_M, KC_COMM, KC_DOT, LT(5, KC_SLSH), KC_RSPC,
	...
	[1] = LAYOUT(
      ...
      KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCBR, KC_DEL, KC_INS, KC_RCBR, KC_PGDN, KC_PGUP, KC_NO, KC_NO, KC_TRNS,
